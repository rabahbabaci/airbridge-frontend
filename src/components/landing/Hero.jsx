                ...
                <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
                    ...
                    >
                        ...
                        <h1 className="leading-tight">
                            <div className="text-5xl sm:text-6xl lg:text-7xl font-bold bg-gradient-to-r from-blue-600 to-cyan-500 bg-clip-text text-transparent mb-4">
                                Perfect Timing.
                            </div>
                            <div className="text-5xl sm:text-6xl lg:text-7xl font-bold bg-gradient-to-r from-green-600 to-emerald-500 bg-clip-text text-transparent mb-6">
                                Seat Ready.
                            </div>
                            <div className="text-5xl sm:text-6xl lg:text-7xl font-bold flex items-center gap-4">
                                ...
                                <Plane className="w-12 h-12 sm:w-14 sm:h-14 lg:w-16 lg:h-16 text-purple-600" />
                            </div>
                        </h1>
